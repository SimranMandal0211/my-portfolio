...
const stats = [
  ...
  return(
    <section id="about"
      className="min-h-screen w-full flex items-center justify-center relative bg-[#000712] text-white overflow-hidden -mt-1"
    >
      <div className="absolute inset-0 pointer-events-none">
        {glows.map((c,i) => (
          <div key={i} className={`absolute rounded-full bg-gradient-to-r from-[#1dd1a1] via-[#0d6e6e] to-[#1dd1a1] animate-pulse ${c}`} />
        ))}
