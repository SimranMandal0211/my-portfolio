  ...
  if(layout === "desktop"){
    return(
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        ...
        <motion.article className={`absolute ${idx%2=== 0 ? "bottom-12" : "top-8"} bg-gray-900/80 backdrop-blur border border-gray-700/70 rounded-xl p-7 w-[320px] shadow-lg`}
...
export default function Experience(){
  ...
  const {scrollYProgress} = useScroll({
    target : scaneRef, offset: ["start start", "end end"]
  });
